// This shader is from https://www.patreon.com/posts/quick-game-art-18245226 and has been made by MinionsArt. 
...
public class Liquid : MonoBehaviour
{
    ...
    [SerializeField] Material liquidMat;
    ...
    void Update()
    {
        ...
        liquidMat.SetFloat("_WobbleX", wobbleAmountX);
        liquidMat.SetFloat("_WobbleZ", wobbleAmountZ);
    ...
    void UpdatePos(float deltaTime)
    {
        ...
        liquidMat.SetVector("_FillAmount", pos);
    }
